...
quiver(real(R_Grey)+RO4O2x, imag(R_Grey)+RO4O2y, real(A_Grey_1)/120, imag(A_Grey_1)/120, 0, 'Color',[0.5 0.5 0.5], 'LineWidth', 2);
quiver(real(R_Cyan), imag(R_Cyan), real(A_Cyan_1)/140, imag(A_Cyan_1)/140, 0, 'c', 'LineWidth', 2);
quiver(real(R_Cyan), imag(R_Cyan), real(A_Red_Rel_1)/40, imag(A_Red_Rel_1)/40, 0, 'r', 'LineWidth', 2);
quiver(real(R_Cyan_Up), imag(R_Cyan_Up), real(A_Cyan_Up_1)/140, imag(A_Cyan_Up_1)/140, 0, 'c', 'LineWidth', 2);
quiver(real(R_Cyan_Up), imag(R_Cyan_Up), real(A_Blue_Rel_1)/140, imag(A_Blue_Rel_1)/140, 0, 'b', 'LineWidth', 2);
...
quiver(real(R_Grey_2)+RO4O2x, imag(R_Grey_2)+RO4O2y, real(A_Grey_2)/160, imag(A_Grey_2)/160, 0, 'Color',[0.5 0.5 0.5], 'LineWidth', 2);
quiver(real(R_Cyan_2), imag(R_Cyan_2), real(A_Cyan_2)/180, imag(A_Cyan_2)/180, 0, 'c', 'LineWidth', 2);
quiver(real(R_Cyan_2), imag(R_Cyan_2), real(A_Red_Rel_2)/20, imag(A_Red_Rel_2)/20, 0, 'r', 'LineWidth', 2);
quiver(real(R_Cyan_Up_2), imag(R_Cyan_Up_2), real(A_Cyan_Up_2)/180, imag(A_Cyan_Up_2)/180, 0, 'c', 'LineWidth', 2);
quiver(real(R_Cyan_Up_2), imag(R_Cyan_Up_2), real(A_Blue_Rel_2)/200, imag(A_Blue_Rel_2)/200, 0, 'b', 'LineWidth', 2);
