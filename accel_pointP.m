...
% Plot Point P
quiver(real(R_P_1), imag(R_P_1), real(A_P_1)/80, imag(A_P_1)/80, 0, 'Color', [0.6 0.3 0], 'LineWidth', 2);
plot(real(R_P_1), imag(R_P_1), 'mo', 'MarkerFaceColor', 'y');
axis equal; grid on;
...
% Plot Point P
quiver(real(R_P_2), imag(R_P_2), real(A_P_2)/80, imag(A_P_2)/80, 0, 'Color', [0.6 0.3 0], 'LineWidth', 2);
plot(real(R_P_2), imag(R_P_2), 'mo', 'MarkerFaceColor', 'y');
axis equal; grid on;
